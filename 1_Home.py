...
st.page_link('pages/2_Preset Itinerary.py', label = 'Preset Itinerary')
st.caption('*find your personalized itinerary from our custom preset itinerary*')

st.page_link('pages/3_Custom Itinerary.py', label = 'Custom Itinerary')
st.caption('*build your own itinerary from cities of your choice*')

st.page_link('pages/4_Generated Itinerary.py', label = 'Generated Itinerary')
